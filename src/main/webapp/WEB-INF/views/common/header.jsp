    ...
    <main class="page-wrapper">
        ...
        <header class="navbar navbar-expand-lg navbar-light fixed-top" data-scroll-header>
            <div class="container">
                ...
                <a class="btn btn-primary btn-sm rounded-pill ms-2 order-lg-3" href="city-guide-add-business.html"><i class="fi-plus me-2"></i>Sign<span class='d-none d-sm-inline'> Up</span></a>
